...
series: "Starting a Business in Australia"
seriesOrder: 4
---

Once your business is set up, the next step is understanding your tax obligations.

This is where many business owners feel unsure — not because it's complicated, but because no one clearly explains what applies to you and when.

You don't need to register for everything straight away. But you do need to understand:
...
- you want to claim GST back on your own business expenses (for example, on equipment, software, or services you pay for)
...
If you have employees, this becomes your responsibility.

When you pay your employees, you don't pay them their full salary. You:
- take out the required tax
- send that tax to the ATO on their behalf

In simple terms — you are collecting tax for the government as part of your payroll.

PAYG withholding applies when you:
- hire employees
...
As your business grows, the ATO may require you to start paying your income tax in advance, throughout the year.
...
You must:
- calculate the correct super amount
- pay it into the employee's super fund
- make payments on time (at least quarterly)

Late payments can result in penalties and additional charges.
...
- **Each quarter (or month)** → BAS + super payments
- **Once per year** → tax return

Tax obligations are not something you set once and forget. They change as your business grows. Understanding what applies to you — and when — will help you stay compliant and avoid unnecessary issues.

Once you understand your obligations, the next step is making sure everything is properly recorded. This is where record keeping becomes essential.
